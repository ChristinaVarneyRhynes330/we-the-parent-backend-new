...
Would you like me to help you gather the specific information needed for your case?`,
...
**Current Focus**: What phase is your case in? I can provide specific guidance for your situation.`,
...
What specific type of evidence are you looking to strengthen for your case?`,
...
**Remember**: Stay calm, be respectful, focus on your child's best interests, and highlight your positive changes. What type of hearing is coming up, and what specific concerns do you have about it?`
};
...
// Start server
app.listen(PORT, () => {
  console.log(`We The Parent API Server running on http://localhost:${PORT}`);
